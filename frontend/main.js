    ...
    xmlHttp.onreadystatechange = function () {
        ...
        if (this.readyState == 4 && this.status == 201) {
            ...
            <div class="data-tweet">
                <img src="IMG/2.jpg">
                <strong>${masukanTweet.email}</strong> <span${masukanTweet.email} </span>
    ...
    xmlHttp.onreadystatechange = function () {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            JSON.parse(this.response).forEach(function (data, index) {
                ...
                // }
                document.getElementById('tweetscontainer').insertAdjacentHTML("afterbegin", 
            ...
            <div class="button">
                ...
                <button type="submit" id="delete-tweet" onclick="deleteTweet(${data.id})">Delete</button>
                </div>
